...
path = os.path.abspath(os.path.dirname(__file__)) + '\Исходящие вызовы абонента.xlsx'
...
print(res1)
x = res1.loc['Итого'].to_list()[2:7]

labels = ['Монстр общения','33 копейки','Хочу сказать','Много звонков','Больше слов']
plt.figure(figsize=(14,7),dpi = 60)
plt.title('Затраты на связь в зависимости от тарифа',color = 'black', weight = 'bold', family = 'sans-serif', size = 22)
plt.xlabel('Тариф',color = 'black', weight = 'bold', family = 'sans-serif', fontsize = 14)
plt.ylabel('Стоимость,руб',color = 'black', weight = 'bold', family = 'sans-serif', fontsize = 14)
